...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Civ5_Leaders_Reborn\Texture_Source\maria_hair_diff.DDS"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>164858124</m_ExportedTime>
	<m_ClassName text="Leader_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="maria_hair_diff.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="maria_hair_diff"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
