...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Civ5_Leaders_Reborn\Texture_Source\maria_dress_gloss.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>174338662</m_ExportedTime>
	<m_ClassName text="Leader_Gloss"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="maria_dress_gloss.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="maria_dress_gloss"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
