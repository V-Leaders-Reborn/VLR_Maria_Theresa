...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Civ5_Leaders_Reborn\Texture_Source\maria_dress_norm.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3961534092</m_ExportedTime>
	<m_ClassName text="Leader_Normal"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="maria_dress_norm.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="maria_dress_norm"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
