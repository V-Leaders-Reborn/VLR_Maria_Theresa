...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Civ5_Leaders_Reborn\Texture_Source\maria_skin_blur.DDS"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4262540058</m_ExportedTime>
	<m_ClassName text="Leader_BlurWidth"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="maria_skin_blur.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="maria_skin_blur"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
