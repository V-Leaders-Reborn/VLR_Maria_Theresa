...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Civ5_Leaders_Reborn\Texture_Source\maria_dress_metal.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>502302400</m_ExportedTime>
	<m_ClassName text="Leader_Metalness"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="maria_dress_metal.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="maria_dress_metal"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
