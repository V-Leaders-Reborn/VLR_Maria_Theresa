...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Civ5_Leaders_Reborn\Texture_Source\maria_teeth_diff.DDS"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1080158050</m_ExportedTime>
	<m_ClassName text="Leader_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="maria_teeth_diff.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="maria_teeth_diff"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
